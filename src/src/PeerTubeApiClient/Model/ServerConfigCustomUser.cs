...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServerConfigCustom_user")]
    public partial class ServerConfigCustomUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigCustomUser" /> class.
        /// </summary>
        /// <param name="videoQuota">videoQuota.</param>
        /// <param name="videoQuotaDaily">videoQuotaDaily.</param>
        public ServerConfigCustomUser(int videoQuota = default(int), int videoQuotaDaily = default(int))
        {
