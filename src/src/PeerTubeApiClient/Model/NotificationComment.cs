...
namespace PeerTubeApiClient.Model
{
    ...
    /// NotificationComment
    /// </summary>
    [DataContract(Name = "Notification_comment")]
    public partial class NotificationComment : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationComment" /> class.
        /// </summary>
        ...
        public NotificationComment(int id = default(int), int threadId = default(int), VideoInfo video = default(VideoInfo), ActorInfo account = default(ActorInfo), bool heldForReview = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotificationComment {\n");
