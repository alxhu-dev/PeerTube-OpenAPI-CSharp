...
namespace PeerTubeApiClient.Model
{
    ...
    /// UserWithStats
    /// </summary>
    [DataContract(Name = "UserWithStats")]
    public partial class UserWithStats : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserWithStats" /> class.
        /// </summary>
        ...
        /// <param name="videosCount">Count of videos published.</param>
        /// <param name="abusesCount">Count of reports/abuses of which the user is a target.</param>
        /// <param name="abusesAcceptedCount">Count of reports/abuses created by the user and accepted/acted upon by the moderation team.</param>
        /// <param name="abusesCreatedCount">Count of reports/abuses created by the user.</param>
        /// <param name="videoCommentsCount">Count of comments published.</param>
        public UserWithStats(Account account = default(Account), bool autoPlayNextVideo = default(bool), bool autoPlayNextVideoPlaylist = default(bool), bool autoPlayVideo = default(bool), bool blocked = default(bool), string blockedReason = default(string), string createdAt = default(string), string email = default(string), bool emailVerified = default(bool), string pluginAuth = default(string), DateTime lastLoginDate = default(DateTime), bool noInstanceConfigWarningModal = default(bool), bool noAccountSetupWarningModal = default(bool), bool noWelcomeModal = default(bool), NSFWPolicy? nsfwPolicy = default(NSFWPolicy?), UserRole role = default(UserRole), string theme = default(string), string username = default(string), List<VideoChannel> videoChannels = default(List<VideoChannel>), int videoQuota = default(int), int videoQuotaDaily = default(int), bool p2pEnabled = default(bool), int videosCount = default(int), int abusesCount = default(int), int abusesAcceptedCount = default(int), int abusesCreatedCount = default(int), int videoCommentsCount = default(int))
        {
        ...
        /// </summary>
        /// <value>Count of videos published</value>
        [DataMember(Name = "videosCount", EmitDefaultValue = false)]
        public int VideosCount { get; set; }

        /// <summary>
        /// Count of reports/abuses of which the user is a target
        /// </summary>
        /// <value>Count of reports/abuses of which the user is a target</value>
        [DataMember(Name = "abusesCount", EmitDefaultValue = false)]
        public int AbusesCount { get; set; }

        /// <summary>
        /// Count of reports/abuses created by the user and accepted/acted upon by the moderation team
        /// </summary>
        /// <value>Count of reports/abuses created by the user and accepted/acted upon by the moderation team</value>
        [DataMember(Name = "abusesAcceptedCount", EmitDefaultValue = false)]
        public int AbusesAcceptedCount { get; set; }

        /// <summary>
        /// Count of reports/abuses created by the user
        /// </summary>
        /// <value>Count of reports/abuses created by the user</value>
        [DataMember(Name = "abusesCreatedCount", EmitDefaultValue = false)]
        public int AbusesCreatedCount { get; set; }

        /// <summary>
        /// Count of comments published
        /// </summary>
        /// <value>Count of comments published</value>
        [DataMember(Name = "videoCommentsCount", EmitDefaultValue = false)]
        public int VideoCommentsCount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VideosCount: ").Append(VideosCount).Append("\n");
            sb.Append("  AbusesCount: ").Append(AbusesCount).Append("\n");
            sb.Append("  AbusesAcceptedCount: ").Append(AbusesAcceptedCount).Append("\n");
            sb.Append("  AbusesCreatedCount: ").Append(AbusesCreatedCount).Append("\n");
            sb.Append("  VideoCommentsCount: ").Append(VideoCommentsCount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
