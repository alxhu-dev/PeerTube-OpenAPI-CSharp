...
namespace PeerTubeApiClient.Model
{
    ...
    /// ServerConfigPlugin
    /// </summary>
    [DataContract(Name = "ServerConfig_plugin")]
    public partial class ServerConfigPlugin : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigPlugin" /> class.
        /// </summary>
        /// <param name="registered">registered.</param>
        public ServerConfigPlugin(List<string> registered = default(List<string>))
        {
