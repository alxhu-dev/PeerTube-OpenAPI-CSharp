...
namespace PeerTubeApiClient.Model
{
    ...
    /// ServerConfigUser
    /// </summary>
    [DataContract(Name = "ServerConfig_user")]
    public partial class ServerConfigUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigUser" /> class.
        /// </summary>
        /// <param name="videoQuota">In bytes.</param>
        /// <param name="videoQuotaDaily">In bytes.</param>
        public ServerConfigUser(int videoQuota = default(int), int videoQuotaDaily = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServerConfigUser {\n");
