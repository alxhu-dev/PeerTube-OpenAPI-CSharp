...
namespace PeerTubeApiClient.Model
{
    ...
    /// VideoChannel
    /// </summary>
    [DataContract(Name = "VideoChannel")]
    public partial class VideoChannel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoChannel" /> class.
        /// </summary>
        ...
        public VideoChannel(int id = default(int), string url = default(string), string name = default(string), List<ActorImage> avatars = default(List<ActorImage>), string host = default(string), bool hostRedundancyAllowed = default(bool), int followingCount = default(int), int followersCount = default(int), DateTime createdAt = default(DateTime), string displayName = default(string), string description = default(string), string support = default(string), List<ActorImage> banners = default(List<ActorImage>), Account ownerAccount = default(Account))
        {
            this.Id = id;
            this.Url = url;
            this.Name = name;
