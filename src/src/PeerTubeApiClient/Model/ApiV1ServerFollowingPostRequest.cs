...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_server_following_post_request")]
    public partial class ApiV1ServerFollowingPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1ServerFollowingPostRequest" /> class.
        /// </summary>
        /// <param name="hosts">hosts.</param>
        /// <param name="handles">handles.</param>
        public ApiV1ServerFollowingPostRequest(List<string> hosts = default(List<string>), List<string> handles = default(List<string>))
        {
            this.Hosts = hosts;
