...
namespace PeerTubeApiClient.Api
{
    ...
    public partial class VideosApi : IVideosApi
    {
        ...
        /// <returns></returns>
        public VideosApi(PeerTubeApiClient.Client.Configuration configuration)
        {
        ...
        public VideosApi(PeerTubeApiClient.Client.ISynchronousClient client, PeerTubeApiClient.Client.IAsynchronousClient asyncClient, PeerTubeApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        public PeerTubeApiClient.Client.ApiResponse<AddVideoPlaylistVideo200Response> AddVideoPlaylistVideoWithHttpInfo(int playlistId, AddVideoPlaylistVideoRequest? addVideoPlaylistVideoRequest = default(AddVideoPlaylistVideoRequest?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.AddVideoPlaylistVideo";
        ...
        public PeerTubeApiClient.Client.ApiResponse<VideoListResponse> ApiV1UsersMeSubscriptionsVideosGetWithHttpInfo(GetAccountVideosCategoryOneOfParameter? categoryOneOf = default(GetAccountVideosCategoryOneOfParameter?), bool? isLive = default(bool?), GetAccountVideosTagsOneOfParameter? tagsOneOf = default(GetAccountVideosTagsOneOfParameter?), GetAccountVideosTagsAllOfParameter? tagsAllOf = default(GetAccountVideosTagsAllOfParameter?), GetAccountVideosLicenceOneOfParameter? licenceOneOf = default(GetAccountVideosLicenceOneOfParameter?), GetAccountVideosLanguageOneOfParameter? languageOneOf = default(GetAccountVideosLanguageOneOfParameter?), GetAccountVideosTagsAllOfParameter? autoTagOneOf = default(GetAccountVideosTagsAllOfParameter?), string? nsfw = default(string?), bool? isLocal = default(bool?), int? include = default(int?), VideoPrivacySet? privacyOneOf = default(VideoPrivacySet?), bool? hasHLSFiles = default(bool?), bool? hasWebVideoFiles = default(bool?), string? skipCount = default(string?), int? start = default(int?), int? count = default(int?), string? sort = default(string?), bool? excludeAlreadyWatched = default(bool?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.ApiV1UsersMeSubscriptionsVideosGet";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public PeerTubeApiClient.Client.ApiResponse<VideoListResponse> ApiV1UsersMeVideosGetWithHttpInfo(int? start = default(int?), int? count = default(int?), string? sort = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.ApiV1UsersMeVideosGet";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public PeerTubeApiClient.Client.ApiResponse<VideoImportsList> ApiV1UsersMeVideosImportsGetWithHttpInfo(int? start = default(int?), int? count = default(int?), string? sort = default(string?), string? targetUrl = default(string?), decimal? videoChannelSyncId = default(decimal?), string? search = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.ApiV1UsersMeVideosImportsGet";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public PeerTubeApiClient.Client.ApiResponse<VideoListResponse> GetVideoPlaylistVideosWithHttpInfo(int playlistId, int? start = default(int?), int? count = default(int?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.GetVideoPlaylistVideos";
            localVarRequestOptions.OperationIndex = operationIndex;
