...
namespace PeerTubeApiClient.Api
{
    ...
    /// </summary>
    public interface IVideoImportsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void ApiV1VideosImportsIdCancelPost(int id, int operationIndex = 0);
        ...
        ApiResponse<Object> ApiV1VideosImportsIdCancelPostWithHttpInfo(int id, int operationIndex = 0);
        /// <summary>
        /// Delete video import
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void ApiV1VideosImportsIdDelete(int id, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> ApiV1VideosImportsIdDeleteWithHttpInfo(int id, int operationIndex = 0);
        /// <summary>
        /// Import a video
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<VideoUploadResponse> ImportVideoWithHttpInfo(string name, int channelId, VideoPrivacySet? privacy = default(VideoPrivacySet?), int? category = default(int?), int? licence = default(int?), string? language = default(string?), string? description = default(string?), bool? waitTranscoding = default(bool?), bool? generateTranscription = default(bool?), string? support = default(string?), bool? nsfw = default(bool?), List<string>? tags = default(List<string>?), bool? commentsEnabled = default(bool?), VideoCommentsPolicySet? commentsPolicy = default(VideoCommentsPolicySet?), bool? downloadEnabled = default(bool?), DateTime? originallyPublishedAt = default(DateTime?), VideoScheduledUpdate? scheduleUpdate = default(VideoScheduledUpdate?), System.IO.Stream? thumbnailfile = default(System.IO.Stream?), System.IO.Stream? previewfile = default(System.IO.Stream?), List<string>? videoPasswords = default(List<string>?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoImportsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task ApiV1VideosImportsIdCancelPostAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ApiV1VideosImportsIdCancelPostWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete video import
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ApiV1VideosImportsIdDeleteAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ApiV1VideosImportsIdDeleteWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Import a video
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<VideoUploadResponse>> ImportVideoWithHttpInfoAsync(string name, int channelId, VideoPrivacySet? privacy = default(VideoPrivacySet?), int? category = default(int?), int? licence = default(int?), string? language = default(string?), string? description = default(string?), bool? waitTranscoding = default(bool?), bool? generateTranscription = default(bool?), string? support = default(string?), bool? nsfw = default(bool?), List<string>? tags = default(List<string>?), bool? commentsEnabled = default(bool?), VideoCommentsPolicySet? commentsPolicy = default(VideoCommentsPolicySet?), bool? downloadEnabled = default(bool?), DateTime? originallyPublishedAt = default(DateTime?), VideoScheduledUpdate? scheduleUpdate = default(VideoScheduledUpdate?), System.IO.Stream? thumbnailfile = default(System.IO.Stream?), System.IO.Stream? previewfile = default(System.IO.Stream?), List<string>? videoPasswords = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoImportsApi : IVideoImportsApiSync, IVideoImportsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VideoImportsApi : IVideoImportsApi
    {
        private PeerTubeApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VideoImportsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public VideoImportsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public VideoImportsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public VideoImportsApi(PeerTubeApiClient.Client.Configuration configuration)
        {
        ...
        public VideoImportsApi(PeerTubeApiClient.Client.ISynchronousClient client, PeerTubeApiClient.Client.IAsynchronousClient asyncClient, PeerTubeApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Cancel video import Cancel a pending video import
        /// </summary>
        /// <exception cref="PeerTubeApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Entity id</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void ApiV1VideosImportsIdCancelPost(int id, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PeerTubeApiClient.Client.ApiResponse<Object> ApiV1VideosImportsIdCancelPostWithHttpInfo(int id, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideoImportsApi.ApiV1VideosImportsIdCancelPost";
            ...
            var localVarResponse = this.Client.Post<Object>("/api/v1/videos/imports/{id}/cancel", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1VideosImportsIdCancelPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ApiV1VideosImportsIdCancelPostAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ApiV1VideosImportsIdCancelPostWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<PeerTubeApiClient.Client.ApiResponse<Object>> ApiV1VideosImportsIdCancelPostWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/v1/videos/imports/{id}/cancel", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Delete video import Delete ended video import
        /// </summary>
        /// <exception cref="PeerTubeApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Entity id</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void ApiV1VideosImportsIdDelete(int id, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PeerTubeApiClient.Client.ApiResponse<Object> ApiV1VideosImportsIdDeleteWithHttpInfo(int id, int operationIndex = 0)
        {
            PeerTubeApiClient.Client.RequestOptions localVarRequestOptions = new PeerTubeApiClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "VideoImportsApi.ApiV1VideosImportsIdDelete";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/api/v1/videos/imports/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1VideosImportsIdDelete", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ApiV1VideosImportsIdDeleteAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ApiV1VideosImportsIdDeleteWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<PeerTubeApiClient.Client.ApiResponse<Object>> ApiV1VideosImportsIdDeleteWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/api/v1/videos/imports/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Import a video Import a torrent or magnetURI or HTTP resource (if enabled by the instance administrator)
        /// </summary>
        /// <exception cref="PeerTubeApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">Video name</param>
        /// <param name="channelId">Channel id that will contain this video</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VideoUploadResponse</returns>
        public PeerTubeApiClient.Client.ApiResponse<VideoUploadResponse> ImportVideoWithHttpInfo(string name, int channelId, VideoPrivacySet? privacy = default(VideoPrivacySet?), int? category = default(int?), int? licence = default(int?), string? language = default(string?), string? description = default(string?), bool? waitTranscoding = default(bool?), bool? generateTranscription = default(bool?), string? support = default(string?), bool? nsfw = default(bool?), List<string>? tags = default(List<string>?), bool? commentsEnabled = default(bool?), VideoCommentsPolicySet? commentsPolicy = default(VideoCommentsPolicySet?), bool? downloadEnabled = default(bool?), DateTime? originallyPublishedAt = default(DateTime?), VideoScheduledUpdate? scheduleUpdate = default(VideoScheduledUpdate?), System.IO.Stream? thumbnailfile = default(System.IO.Stream?), System.IO.Stream? previewfile = default(System.IO.Stream?), List<string>? videoPasswords = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new PeerTubeApiClient.Client.ApiException(400, "Missing required parameter 'name' when calling VideoImportsApi->ImportVideo");
            }
            ...
            localVarRequestOptions.Operation = "VideoImportsApi.ImportVideo";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<VideoUploadResponse>("/api/v1/videos/imports", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportVideo", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VideoUploadResponse</returns>
        public async System.Threading.Tasks.Task<VideoUploadResponse> ImportVideoAsync(string name, int channelId, VideoPrivacySet? privacy = default(VideoPrivacySet?), int? category = default(int?), int? licence = default(int?), string? language = default(string?), string? description = default(string?), bool? waitTranscoding = default(bool?), bool? generateTranscription = default(bool?), string? support = default(string?), bool? nsfw = default(bool?), List<string>? tags = default(List<string>?), bool? commentsEnabled = default(bool?), VideoCommentsPolicySet? commentsPolicy = default(VideoCommentsPolicySet?), bool? downloadEnabled = default(bool?), DateTime? originallyPublishedAt = default(DateTime?), VideoScheduledUpdate? scheduleUpdate = default(VideoScheduledUpdate?), System.IO.Stream? thumbnailfile = default(System.IO.Stream?), System.IO.Stream? previewfile = default(System.IO.Stream?), List<string>? videoPasswords = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            PeerTubeApiClient.Client.ApiResponse<VideoUploadResponse> localVarResponse = await ImportVideoWithHttpInfoAsync(name, channelId, privacy, category, licence, language, description, waitTranscoding, generateTranscription, support, nsfw, tags, commentsEnabled, commentsPolicy, downloadEnabled, originallyPublishedAt, scheduleUpdate, thumbnailfile, previewfile, videoPasswords, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VideoUploadResponse)</returns>
        public async System.Threading.Tasks.Task<PeerTubeApiClient.Client.ApiResponse<VideoUploadResponse>> ImportVideoWithHttpInfoAsync(string name, int channelId, VideoPrivacySet? privacy = default(VideoPrivacySet?), int? category = default(int?), int? licence = default(int?), string? language = default(string?), string? description = default(string?), bool? waitTranscoding = default(bool?), bool? generateTranscription = default(bool?), string? support = default(string?), bool? nsfw = default(bool?), List<string>? tags = default(List<string>?), bool? commentsEnabled = default(bool?), VideoCommentsPolicySet? commentsPolicy = default(VideoCommentsPolicySet?), bool? downloadEnabled = default(bool?), DateTime? originallyPublishedAt = default(DateTime?), VideoScheduledUpdate? scheduleUpdate = default(VideoScheduledUpdate?), System.IO.Stream? thumbnailfile = default(System.IO.Stream?), System.IO.Stream? previewfile = default(System.IO.Stream?), List<string>? videoPasswords = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<VideoUploadResponse>("/api/v1/videos/imports", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
