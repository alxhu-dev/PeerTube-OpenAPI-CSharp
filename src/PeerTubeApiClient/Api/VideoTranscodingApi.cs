...
namespace PeerTubeApiClient.Api
{
    ...
    /// </summary>
    public interface IVideoTranscodingApiSync : IApiAccessor
    {
        ...
        /// <exception cref="PeerTubeApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The object id, uuid or short uuid</param>
        /// <param name="createVideoTranscodingRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void CreateVideoTranscoding(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CreateVideoTranscodingWithHttpInfo(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoTranscodingApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CreateVideoTranscodingAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CreateVideoTranscodingWithHttpInfoAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoTranscodingApi : IVideoTranscodingApiSync, IVideoTranscodingApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VideoTranscodingApi : IVideoTranscodingApi
    {
        private PeerTubeApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VideoTranscodingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public VideoTranscodingApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public VideoTranscodingApi(string basePath)
        {
        ...
        /// <returns></returns>
        public VideoTranscodingApi(PeerTubeApiClient.Client.Configuration configuration)
        {
        ...
        public VideoTranscodingApi(PeerTubeApiClient.Client.ISynchronousClient client, PeerTubeApiClient.Client.IAsynchronousClient asyncClient, PeerTubeApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        public PeerTubeApiClient.Client.ApiResponse<Object> ApiV1VideosIdStudioEditPostWithHttpInfo(ApiV1VideosOwnershipIdAcceptPostIdParameter id, int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new PeerTubeApiClient.Client.ApiException(400, "Missing required parameter 'id' when calling VideoTranscodingApi->ApiV1VideosIdStudioEditPost");
            }
            ...
            localVarRequestOptions.Operation = "VideoTranscodingApi.ApiV1VideosIdStudioEditPost";
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void CreateVideoTranscoding(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PeerTubeApiClient.Client.ApiResponse<Object> CreateVideoTranscodingWithHttpInfo(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new PeerTubeApiClient.Client.ApiException(400, "Missing required parameter 'id' when calling VideoTranscodingApi->CreateVideoTranscoding");
            }
            ...
            localVarRequestOptions.PathParameters.Add("id", PeerTubeApiClient.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = createVideoTranscodingRequest;

            localVarRequestOptions.Operation = "VideoTranscodingApi.CreateVideoTranscoding";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/v1/videos/{id}/transcoding", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CreateVideoTranscoding", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CreateVideoTranscodingAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CreateVideoTranscodingWithHttpInfoAsync(id, createVideoTranscodingRequest, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<PeerTubeApiClient.Client.ApiResponse<Object>> CreateVideoTranscodingWithHttpInfoAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, CreateVideoTranscodingRequest? createVideoTranscodingRequest = default(CreateVideoTranscodingRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/v1/videos/{id}/transcoding", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
