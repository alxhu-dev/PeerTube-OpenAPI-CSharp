...
namespace PeerTubeApiClient.Api
{
    ...
    /// </summary>
    public interface IVideoRatesApiSync : IApiAccessor
    {
        ...
        /// <param name="apiV1VideosIdRatePutRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void ApiV1VideosIdRatePut(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0);
        ...
        ApiResponse<Object> ApiV1VideosIdRatePutWithHttpInfo(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoRatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task ApiV1VideosIdRatePutAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ApiV1VideosIdRatePutWithHttpInfoAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideoRatesApi : IVideoRatesApiSync, IVideoRatesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VideoRatesApi : IVideoRatesApi
    {
        private PeerTubeApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VideoRatesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public VideoRatesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public VideoRatesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public VideoRatesApi(PeerTubeApiClient.Client.Configuration configuration)
        {
        ...
        public VideoRatesApi(PeerTubeApiClient.Client.ISynchronousClient client, PeerTubeApiClient.Client.IAsynchronousClient asyncClient, PeerTubeApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        public PeerTubeApiClient.Client.ApiResponse<GetMeVideoRating> ApiV1UsersMeVideosVideoIdRatingGetWithHttpInfo(int videoId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideoRatesApi.ApiV1UsersMeVideosVideoIdRatingGet";
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void ApiV1VideosIdRatePut(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0)
        {
            ApiV1VideosIdRatePutWithHttpInfo(id, xPeertubeVideoPassword, apiV1VideosIdRatePutRequest);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PeerTubeApiClient.Client.ApiResponse<Object> ApiV1VideosIdRatePutWithHttpInfo(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new PeerTubeApiClient.Client.ApiException(400, "Missing required parameter 'id' when calling VideoRatesApi->ApiV1VideosIdRatePut");
            }
            ...
            localVarRequestOptions.Data = apiV1VideosIdRatePutRequest;

            localVarRequestOptions.Operation = "VideoRatesApi.ApiV1VideosIdRatePut";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/api/v1/videos/{id}/rate", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1VideosIdRatePut", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ApiV1VideosIdRatePutAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ApiV1VideosIdRatePutWithHttpInfoAsync(id, xPeertubeVideoPassword, apiV1VideosIdRatePutRequest, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<PeerTubeApiClient.Client.ApiResponse<Object>> ApiV1VideosIdRatePutWithHttpInfoAsync(ApiV1VideosOwnershipIdAcceptPostIdParameter id, string? xPeertubeVideoPassword = default(string?), ApiV1VideosIdRatePutRequest? apiV1VideosIdRatePutRequest = default(ApiV1VideosIdRatePutRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/api/v1/videos/{id}/rate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
