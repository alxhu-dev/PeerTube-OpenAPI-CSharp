...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VideoCommentsForXML_inner")]
    public partial class VideoCommentsForXMLInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoCommentsForXMLInner" /> class.
        /// </summary>
        ...
        public VideoCommentsForXMLInner(string link = default(string), string guid = default(string), DateTime pubDate = default(DateTime), string contentencoded = default(string), string dccreator = default(string))
        {
            this.Link = link;
            this.Guid = guid;
