...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServerConfigCustom_instance")]
    public partial class ServerConfigCustomInstance : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigCustomInstance" /> class.
        /// </summary>
        ...
        public ServerConfigCustomInstance(string name = default(string), string shortDescription = default(string), string description = default(string), string terms = default(string), string defaultClientRoute = default(string), bool isNSFW = default(bool), string defaultNSFWPolicy = default(string), ServerConfigInstanceCustomizations customizations = default(ServerConfigInstanceCustomizations))
        {
            this.Name = name;
