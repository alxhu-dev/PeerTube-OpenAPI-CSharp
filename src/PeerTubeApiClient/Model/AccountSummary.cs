...
namespace PeerTubeApiClient.Model
{
    ...
    /// AccountSummary
    /// </summary>
    [DataContract(Name = "AccountSummary")]
    public partial class AccountSummary : IValidatableObject
    {
        /// <summary>
        ...
        public AccountSummary(int id = default(int), string name = default(string), string displayName = default(string), string url = default(string), string host = default(string), List<ActorImage> avatars = default(List<ActorImage>))
        {
            this.Id = id;
            this.Name = name;
