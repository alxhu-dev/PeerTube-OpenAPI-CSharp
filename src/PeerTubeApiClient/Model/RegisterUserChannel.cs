...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegisterUser_channel")]
    public partial class RegisterUserChannel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterUserChannel" /> class.
        /// </summary>
        /// <param name="name">immutable name of the channel, used to interact with its actor.</param>
        /// <param name="displayName">displayName.</param>
        public RegisterUserChannel(string name = default(string), string displayName = default(string))
        {
            this.Name = name;
