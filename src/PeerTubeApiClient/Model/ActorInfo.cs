...
namespace PeerTubeApiClient.Model
{
    ...
    /// ActorInfo
    /// </summary>
    [DataContract(Name = "ActorInfo")]
    public partial class ActorInfo : IValidatableObject
    {
        /// <summary>
        ...
        public ActorInfo(int id = default(int), string name = default(string), string displayName = default(string), string host = default(string), List<ActorImage> avatars = default(List<ActorImage>))
        {
            this.Id = id;
            this.Name = name;
