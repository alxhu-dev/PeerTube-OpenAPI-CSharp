...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_abuses__abuseId__put_request")]
    public partial class ApiV1AbusesAbuseIdPutRequest : IValidatableObject
    {
        ...
        public AbuseStateSet? State { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1AbusesAbuseIdPutRequest" /> class.
        /// </summary>
        /// <param name="state">state.</param>
        /// <param name="moderationComment">Update the report comment visible only to the moderation team.</param>
        public ApiV1AbusesAbuseIdPutRequest(AbuseStateSet? state = default(AbuseStateSet?), string moderationComment = default(string))
        {
            this.State = state;
        ...
        /// </summary>
        /// <value>Update the report comment visible only to the moderation team</value>
