...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServerStats_videosRedundancy_inner")]
    public partial class ServerStatsVideosRedundancyInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerStatsVideosRedundancyInner" /> class.
        /// </summary>
        /// <param name="strategy">strategy.</param>
        /// <param name="totalSize">totalSize.</param>
        /// <param name="totalUsed">totalUsed.</param>
        /// <param name="totalVideoFiles">totalVideoFiles.</param>
        /// <param name="totalVideos">totalVideos.</param>
        public ServerStatsVideosRedundancyInner(string strategy = default(string), decimal totalSize = default(decimal), decimal totalUsed = default(decimal), decimal totalVideoFiles = default(decimal), decimal totalVideos = default(decimal))
        {
        ...
        /// <summary>
        /// Gets or Sets TotalUsed
        /// </summary>
        [DataMember(Name = "totalUsed", EmitDefaultValue = false)]
        public decimal TotalUsed { get; set; }

        /// <summary>
        /// Gets or Sets TotalVideoFiles
        /// </summary>
        [DataMember(Name = "totalVideoFiles", EmitDefaultValue = false)]
        public decimal TotalVideoFiles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TotalVideoFiles: ").Append(TotalVideoFiles).Append("\n");
