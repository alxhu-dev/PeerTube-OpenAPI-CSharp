...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserRegistration_user")]
    public partial class UserRegistrationUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRegistrationUser" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        public UserRegistrationUser(int id = default(int))
        {
            this.Id = id;
        }
