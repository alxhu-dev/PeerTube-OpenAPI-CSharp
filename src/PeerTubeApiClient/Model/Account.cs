...
namespace PeerTubeApiClient.Model
{
    ...
    public partial class Account : IValidatableObject
    {
        ...
        /// <param name="userId">object id for the user tied to this account.</param>
        /// <param name="displayName">editable name of the account, displayed in its representations.</param>
        /// <param name="description">text or bio displayed on the account&#39;s profile.</param>
        public Account(int id = default(int), string url = default(string), string name = default(string), List<ActorImage> avatars = default(List<ActorImage>), string host = default(string), bool hostRedundancyAllowed = default(bool), int followingCount = default(int), int followersCount = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), int userId = default(int), string displayName = default(string), string description = default(string))
        {
            this.Id = id;
            this.Url = url;
            this.Name = name;
        ...
        /// </summary>
        /// <value>object id for the user tied to this account</value>
        /// <example>42</example>
        ...
        /// </summary>
        /// <value>editable name of the account, displayed in its representations</value>
        ...
        /// </summary>
        /// <value>text or bio displayed on the account&#39;s profile</value>
