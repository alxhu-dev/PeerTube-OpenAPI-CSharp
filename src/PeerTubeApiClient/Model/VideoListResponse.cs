...
namespace PeerTubeApiClient.Model
{
    ...
    /// VideoListResponse
    /// </summary>
    [DataContract(Name = "VideoListResponse")]
    public partial class VideoListResponse : IValidatableObject
    {
        /// <summary>
        ...
        public VideoListResponse(int total = default(int), List<Video> data = default(List<Video>))
        {
            this.Total = total;
            this.Data = data;
        }
