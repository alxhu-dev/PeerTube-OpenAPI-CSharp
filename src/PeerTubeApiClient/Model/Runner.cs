...
namespace PeerTubeApiClient.Model
{
    ...
    public partial class Runner : IValidatableObject
    {
        ...
        public Runner(int id = default(int), string name = default(string), string description = default(string), string ip = default(string), DateTime updatedAt = default(DateTime), DateTime createdAt = default(DateTime), DateTime lastContact = default(DateTime))
        {
            this.Id = id;
            this.Name = name;
