...
namespace PeerTubeApiClient.Model
{
    ...
    public partial class Actor : IValidatableObject
    {
        ...
        public Actor(int id = default(int), string url = default(string), string name = default(string), List<ActorImage> avatars = default(List<ActorImage>), string host = default(string), bool hostRedundancyAllowed = default(bool), int followingCount = default(int), int followersCount = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Url = url;
            this.Name = name;
