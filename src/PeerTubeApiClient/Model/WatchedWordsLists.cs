...
namespace PeerTubeApiClient.Model
{
    ...
    /// WatchedWordsLists
    /// </summary>
    [DataContract(Name = "WatchedWordsLists")]
    public partial class WatchedWordsLists : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WatchedWordsLists" /> class.
        /// </summary>
        ...
        public WatchedWordsLists(int id = default(int), string listName = default(string), List<string> words = default(List<string>), DateTime updatedAt = default(DateTime), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WatchedWordsLists {\n");
