...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServerConfig_instance_customizations")]
    public partial class ServerConfigInstanceCustomizations : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigInstanceCustomizations" /> class.
        /// </summary>
        /// <param name="javascript">javascript.</param>
        /// <param name="css">css.</param>
        public ServerConfigInstanceCustomizations(string javascript = default(string), string css = default(string))
        {
