...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Notification_actorFollow")]
    public partial class NotificationActorFollow : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationActorFollow" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="follower">follower.</param>
        /// <param name="state">state.</param>
        /// <param name="following">following.</param>
        public NotificationActorFollow(int id = default(int), ActorInfo follower = default(ActorInfo), StateEnum? state = default(StateEnum?), NotificationActorFollowFollowing following = default(NotificationActorFollowFollowing))
        {
            this.Id = id;
        ...
        public ActorInfo Follower { get; set; }

        /// <summary>
        /// Gets or Sets Following
        /// </summary>
        [DataMember(Name = "following", EmitDefaultValue = false)]
        public NotificationActorFollowFollowing Following { get; set; }
