...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Notification_videoImport")]
    public partial class NotificationVideoImport : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationVideoImport" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="video">video.</param>
        /// <param name="torrentName">torrentName.</param>
        /// <param name="magnetUri">magnet URI allowing to resolve the import&#39;s source video.</param>
        /// <param name="targetUri">targetUri.</param>
        public NotificationVideoImport(int id = default(int), VideoInfo video = default(VideoInfo), string torrentName = default(string), string magnetUri = default(string), string targetUri = default(string))
        {
            this.Id = id;
            this.Video = video;
        ...
        /// </summary>
        [DataMember(Name = "torrentName", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "targetUri", EmitDefaultValue = true)]
