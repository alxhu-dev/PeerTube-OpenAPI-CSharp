...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserRegistrationRequest")]
    public partial class UserRegistrationRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="email">email of the user, used for login or service communications (required).</param>
        /// <param name="displayName">editable name of the user, displayed in its representations.</param>
        /// <param name="channel">channel.</param>
        /// <param name="registrationReason">reason for the user to register on the instance (required).</param>
        public UserRegistrationRequest(string username = default(string), string password = default(string), string email = default(string), string displayName = default(string), RegisterUserChannel channel = default(RegisterUserChannel), string registrationReason = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for UserRegistrationRequest and cannot be null");
            }
            this.Username = username;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for UserRegistrationRequest and cannot be null");
            }
            this.Password = password;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for UserRegistrationRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "registrationReason" is required (not null)
            if (registrationReason == null)
            {
                throw new ArgumentNullException("registrationReason is a required property for UserRegistrationRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>email of the user, used for login or service communications</value>
        ...
        /// </summary>
        /// <value>editable name of the user, displayed in its representations</value>
        ...
        public RegisterUserChannel Channel { get; set; }

        /// <summary>
        /// reason for the user to register on the instance
        /// </summary>
        /// <value>reason for the user to register on the instance</value>
        [DataMember(Name = "registrationReason", IsRequired = true, EmitDefaultValue = true)]
