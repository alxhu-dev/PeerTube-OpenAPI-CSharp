...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileRedundancyInformation")]
    public partial class FileRedundancyInformation : IValidatableObject
    {
        /// <summary>
        /// Defines Strategy
        /// </summary>
        ...
        public enum StrategyEnum
        {
            ...
            /// <summary>
            /// Enum MostViews for value: most-views
            /// </summary>
            ...
            /// <summary>
            /// Enum RecentlyAdded for value: recently-added
            /// </summary>
            [EnumMember(Value = "recently-added")]
            RecentlyAdded = 4
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileRedundancyInformation" /> class.
        /// </summary>
        ...
        public FileRedundancyInformation(int id = default(int), string fileUrl = default(string), StrategyEnum? strategy = default(StrategyEnum?), int size = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime expiresOn = default(DateTime))
        {
            this.Id = id;
