...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServerConfig_search_remoteUri")]
    public partial class ServerConfigSearchRemoteUri : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerConfigSearchRemoteUri" /> class.
        /// </summary>
        /// <param name="users">users.</param>
        /// <param name="anonymous">anonymous.</param>
        public ServerConfigSearchRemoteUri(bool users = default(bool), bool anonymous = default(bool))
        {
            this.Users = users;
