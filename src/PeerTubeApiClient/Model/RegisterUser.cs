...
namespace PeerTubeApiClient.Model
{
    ...
    /// RegisterUser
    /// </summary>
    [DataContract(Name = "RegisterUser")]
    public partial class RegisterUser : IValidatableObject
    {
        /// <summary>
        ...
        public RegisterUser(string username = default(string), string password = default(string), string email = default(string), string displayName = default(string), RegisterUserChannel channel = default(RegisterUserChannel))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for RegisterUser and cannot be null");
            }
            this.Username = username;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for RegisterUser and cannot be null");
            }
            this.Password = password;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for RegisterUser and cannot be null");
            }
            this.Email = email;
