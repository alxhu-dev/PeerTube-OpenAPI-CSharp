...
namespace PeerTubeApiClient.Model
{
    ...
    /// VideoPassword
    /// </summary>
    [DataContract(Name = "VideoPassword")]
    public partial class VideoPassword : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoPassword" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="password">password.</param>
        /// <param name="videoId">videoId.</param>
        public VideoPassword(int id = default(int), string password = default(string), int videoId = default(int))
        {
            this.Id = id;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Password, length must be greater than 2.", new [] { "Password" });
            }
