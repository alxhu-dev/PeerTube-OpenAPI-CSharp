...
namespace PeerTubeApiClient.Model
{
    ...
    /// VideoUserHistory
    /// </summary>
    [DataContract(Name = "Video_userHistory")]
    public partial class VideoUserHistory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoUserHistory" /> class.
        /// </summary>
        /// <param name="currentTime">currentTime.</param>
        public VideoUserHistory(int currentTime = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VideoUserHistory {\n");
