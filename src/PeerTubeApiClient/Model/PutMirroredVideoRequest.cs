...
namespace PeerTubeApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putMirroredVideo_request")]
    public partial class PutMirroredVideoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMirroredVideoRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutMirroredVideoRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutMirroredVideoRequest" /> class.
        /// </summary>
        /// <param name="videoId">videoId (required).</param>
        public PutMirroredVideoRequest(int videoId = default(int))
        {
