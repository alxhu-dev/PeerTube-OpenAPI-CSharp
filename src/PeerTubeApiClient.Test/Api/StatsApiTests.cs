...
namespace PeerTubeApiClient.Test.Api
{
    ...
    public class StatsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiV1MetricsPlaybackPost
        /// </summary>
        [Fact]
        public void ApiV1MetricsPlaybackPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PlaybackMetricCreate? playbackMetricCreate = null;
            //instance.ApiV1MetricsPlaybackPost(playbackMetricCreate);
        }
        ...
        /// </summary>
        [Fact]
        public void GetInstanceStatsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetInstanceStats();
            //Assert.IsType<ServerStats>(response);
        }
    }
}
