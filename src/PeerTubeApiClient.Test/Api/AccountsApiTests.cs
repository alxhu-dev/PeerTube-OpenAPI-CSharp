...
namespace PeerTubeApiClient.Test.Api
{
    ...
    public class AccountsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiV1AccountsNameRatingsGet
        /// </summary>
        [Fact]
        public void ApiV1AccountsNameRatingsGetTest()
        {
            ...
            //string? sort = null;
            //string? rating = null;
            //var response = instance.ApiV1AccountsNameRatingsGet(name, start, count, sort, rating);
            //Assert.IsType<List<VideoRating>>(response);
        }
        ...
        /// <summary>
        /// Test GetAccountFollowers
        /// </summary>
        [Fact]
        public void GetAccountFollowersTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string name = null;
            //int? start = null;
            ...
            //string? sort = null;
            //string? search = null;
            //var response = instance.GetAccountFollowers(name, start, count, sort, search);
        ...
        public void GetAccountsTest()
        {
            ...
            //int? count = null;
            //string? sort = null;
            //var response = instance.GetAccounts(start, count, sort);
            //Assert.IsType<GetAccounts200Response>(response);
        }
    }
}
