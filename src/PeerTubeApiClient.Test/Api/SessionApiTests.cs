...
namespace PeerTubeApiClient.Test.Api
{
    ...
    public class SessionApiTests : IDisposable
    {
        ...
        /// </summary>
        [Fact]
        public void GetOAuthClientTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetOAuthClient();
            //Assert.IsType<OAuthClient>(response);
        }
        ...
        public void GetOAuthTokenTest()
        {
            ...
            //var response = instance.GetOAuthToken(clientId, clientSecret, grantType, username, password, refreshToken);
            //Assert.IsType<GetOAuthToken200Response>(response);
        }
